---
title: 'Trusting Technology: Programmatic Advertising and Digital Locks'
layout: post
...
But digital has changed everything else: advertising of all types is easier to buy for many more companies; there are thousands – if not millions – of smaller publishers where people spend time and the so-called ad-tech industry has developed hundreds of new technology ideas that sit between the advertiser and the publisher (so many, that the world they inhabit is known as the [Lumascape](https://lumapartners.com/luma-content/), after the company who tries to plot them all). This Lumascape uses technology to make the process of buying and selling across so many different places both easier and more efficient by automating as much of the process as possible. Increasingly, this automation means that the advertiser (who is the buyer) relies on a machine to decide where to buy. Publishers, both old and new, connect their advertising business to these automatic buying machines in the hope that the advertiser actually spends money with them. It’s a process that’s been termed ‘programmatic advertising’.
...
Do you have a connected digital lock on your front door? My guess is that for the odd person who reads this, the answer will be no. Technology has not gained sufficient trust. The problem is, in the modern advertising world, the technology struggles to gain trust from all sides of the market, but most people still have to use it. Advertising can no longer stick with the old-fashioned key; it relies on the digital lock.

And that strange metaphor brings us to the first big story in March’s digital advertising news:

- 16 March: [Guardian pulls ads from Google after they were placed next to extremist material](https://www.theguardian.com/media/2017/mar/16/guardian-pulls-ads-google-placed-extremist-material) (The Guardian)
- 17 March 2017: [UK government pulls ads from YouTube in extremist content row](https://www.newscientist.com/article/2124941-uk-government-pulls-ads-from-youtube-in-extremist-content-row/) (New Scientist)
- 20 March 2017: [Google boss apology as more firms suspend ads over hate videos](http://news.sky.com/story/ms-suspends-google-ads-amid-pressure-over-hate-videos-10808500) (Sky News)
- 23 March 2017:[Verizon, AT&T Added to List of Companies Suspending Google Advertising](http://www.investopedia.com/news/google-revamp-policies-after-clients-pull-ads-goog-fb/) (Investopedia)
- 28 March 2017: [Telstra joins global YouTube boycott as toll mounts on Google](http://www.smh.com.au/business/media-and-marketing/telstra-joins-global-youtube-boycott-as-toll-mounts-on-google-20170328-gv860f.html) (Sydney Morning Herald)
...
Sermon Of the Last Sunday is my attempt to ensure that there is something published on my site every month in 2017. You can read about my [attempts to force myself to write](https://www.curnow.org/2017/01/hashtag-for-a-new-generation/) or review the full #sols collection through the handy site tag, [sols](https://www.curnow.org/tag/sols/).

**Footnotes**

1 [UK Digital Ad Spend Will Continue Double-Digit Growth in 2016](https://www.emarketer.com/Article/UK-Digital-Ad-Spend-Will-Continue-Double-Digit-Growth-2016/1014524), eMarketer, 28 September 2016
2 [History of Advertising in Britain](https://en.wikipedia.org/wiki/History_of_advertising_in_Britain#18th_century), Wikipedia
3 [Google’s crisis of confidence](http://www.bbc.co.uk/news/technology-39331204), BBC
